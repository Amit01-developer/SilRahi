                    ...
                    <div className="flex flex-col items-stretch gap-2 md:items-end">
                      ...
                      {booking.status === "pending" && (
                        <div className="flex gap-2 w-full md:w-auto">
                          <Button type="button" classname="flex-1" onClick={() => openEditModal(booking)}>
                            Edit
                          </Button>
                          <Button type="button" variant="secondary" className="flex-1" onClick={() => cancelBooking(booking.id)}>
                            Cancel
                          </Button>
                        </div>
                      )}
